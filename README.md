...
[![Release](https://github.com/Christ9038/QianuHub-Xianyu-Helper/actions/workflows/release.yml/badge.svg)](https://github.com/Christ9038/QianuHub-Xianyu-Helper/actions/workflows/release.yml)
...
QianuHub Xianyu Helper is a self-hosted management system for Xianyu sellers. It combines account runtimes, instant
...
### Use with QianuHub Referral Assistant

If you promote Xianyu products through cloud-drive resources, tutorials, or digital packages, you can use
[QianuHub Referral Assistant](https://www.qianuhub.com) alongside this project. Create separate short links for products,
channels, or promotion accounts, then inspect PV, UV, trends, rankings, and channel/account reports in the QianuHub
console.

QianuHub identifies where visits and conversion leads come from, while this project handles account messages, orders,
and automated delivery. See the [QianuHub Referral Assistant guide](https://docs.qianuhub.com/guide/quick-start) to create
links and view data.
...
![QianuHub Xianyu Helper Telegram group](https://raw.githubusercontent.com/Christ9038/QianuHub-Xianyu-Helper/main/docs/img/telegram.jpg)
...
![Account management](https://raw.githubusercontent.com/Christ9038/QianuHub-Xianyu-Helper/main/docs/img/preview_account.png)

![Instant messaging](https://raw.githubusercontent.com/Christ9038/QianuHub-Xianyu-Helper/main/docs/img/preview_im.png)

![Automation](https://raw.githubusercontent.com/Christ9038/QianuHub-Xianyu-Helper/main/docs/img/preview_auto.png)
...
| --- | --- | --- | --- |
| Windows | QianuHubXianyuHelper Windows Service | xianyu-tray.exe | C:\ProgramData\QianuHubXianyuHelper |
| macOS | com.qianuhub.xianyu-helper.server LaunchAgent | QianuHub闲鱼助手.app menu-bar program | ~/Library/Application Support/QianuHubXianyuHelper and ~/Library/Logs/QianuHubXianyuHelper |
| Linux | qianuhub-xianyu-helper.service systemd unit | No desktop tray | /var/lib/qianuhub-xianyu-helper and /var/log/qianuhub-xianyu-helper |
...
root on the matching architecture and uses systemd. Uninstall retains /var/lib/qianuhub-xianyu-helper by default.
