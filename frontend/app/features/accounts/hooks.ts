...
export const useAccountsData = (): AccountsDataResult => {
  ...
  // loadAccounts 读取账号详情，并只提交最新请求结果。
  const loadAccounts = useCallback(
    ...
    try {
      ...
      // details 保存账号详情请求结果。
      const details = await getAccountDetails(options);
