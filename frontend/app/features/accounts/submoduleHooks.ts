...
import type { AccountDetail,NotificationChannel } from './api';
import { shouldSaveNotificationBindings } from './accountBindings';
import { cancelPasswordLogin,checkPasswordLoginStatus,getAccountBindings,getLongLoginSettings,getNotificationChannels,passwordLogin,setLongLoginSettings,updateAccountPauseDuration,updateAccountSettings } from './api';
...
export type AccountModalType = 'edit' | null;
...
export const useAccountSubmodules = ({ editingAccount, setEditingAccount, setActiveModal, editForm, setEditForm, loadAccounts }: AccountSubmoduleOptions) => {
  ...
  return {
    ...
    saving, passwordLoginView, setBindingsDirty, setEditForm, openEditModal,
    closeEditModal, loadNotificationBindings, toggleNotificationChannel,
    handleLongLoginToggle, handleSaveEdit, handleRestartPause, handlePasswordLogin,
