...
export type AutomationTriggerType = 'order_paid' | 'review_missing_timeout';
/** 由当前 feature adapter 归一后的 AutomationActionType UI 模型；不直接暴露 HTTP DTO。 */
export type AutomationActionType = 'confirm_shipment' | 'send_card' | 'send_text' | 'republish_item';
