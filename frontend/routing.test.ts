...
describe('frontend navigation routing', () => {
  ...
  test('active navigation uses the primary action blue', () => {
    ...
    expect(sidebar).toContain("'bg-brand-50 text-brand-800 before:absolute before:left-0 before:top-2 before:h-6 before:w-0.5 before:rounded-full before:bg-brand'");
