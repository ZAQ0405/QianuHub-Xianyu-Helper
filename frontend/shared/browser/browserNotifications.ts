...
export const BROWSER_NOTIFICATION_PREFERENCE_KEY = 'qianuhub.browser_notifications.enabled';

/** BROWSER_NOTIFICATION_CHANGE_EVENT 用于同一标签页内同步聊天页与应用壳的通知偏好。 */
const BROWSER_NOTIFICATION_CHANGE_EVENT = 'qianuhub:browser-notification-preference-changed';
