...
func TestOpenAPISuccessContractCoverage(t *testing.T) {
	...
	scenarios := []struct {
		...
		{name: "versioned-settings-cards-notifications", run: TestVersionedSettingsCardNotificationRoutes},
		{name: "versioned-item-batches", run: TestVersionedItemBatchRoutes},
