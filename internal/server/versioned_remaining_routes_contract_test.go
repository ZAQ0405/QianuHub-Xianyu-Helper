...
func TestVersionedRemainingRoutesPreserveLegacyContracts(t *testing.T) {
	...
	cases := []remainingVersionedRouteCase{
		...
		{name: "delivery-templates-removed", method: http.MethodGet, versionedPath: "/api/v1/delivery-templates", wantStatus: http.StatusNotFound},
		{name: "delivery-template-create-removed", method: http.MethodPost, versionedPath: "/api/v1/delivery-templates", body: `{}`, wantStatus: http.StatusMethodNotAllowed},
		{name: "delivery-template-get-removed", method: http.MethodGet, versionedPath: "/api/v1/delivery-templates/invalid", wantStatus: http.StatusNotFound},
		...
		{name: "set-item-multi-spec-removed", method: http.MethodPut, versionedPath: "/api/v1/items/missing-account/item/multi-spec", body: `{}`, wantStatus: http.StatusMethodNotAllowed},
		{name: "set-item-multi-quantity-removed", method: http.MethodPut, versionedPath: "/api/v1/items/missing-account/item/multi-quantity-delivery", body: `{}`, wantStatus: http.StatusMethodNotAllowed},
	}
